<template>
  <div class="s-date-picker" ref="pickerRef">
    <div class="input-wrapper">
      ...
      <s-icon name="setting" class="icon prefix"></s-icon>
      <s-icon name="close" class="icon clear" v-if="value" @click="value=''"></s-icon>
    </div>

    <div class="spread" v-show="pickerVisible" ref="pickerRef">
      <div class="picker">
        <div class="action-bar">

          <div class="icons">
            <span class="icon" @click="handleDoubleNext(-1)">《</span>
            <span class="icon" @click="changeMonth(-1)" v-show="dateListVisible">&lt;</span>
          </div>
